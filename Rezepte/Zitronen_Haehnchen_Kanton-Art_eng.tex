...
\section[Lemon Chicken, the Original Cantonese style]{\leafright\, Lemon Chicken, the Original Cantonese style \leafleft}
...
\multicolumn{2}{c}{\textbf{Ingredients für 2 portions}}\\ \toprule
...
\begin{small}
\begin{tabular}{R{1.6cm} L{3.8cm} }
\multicolumn{2}{c}{\textbf{Coating for the chicken}}\\ \toprule
...
\begin{small}
\begin{tabular}{R{1.6cm} L{3.8cm} }
\multicolumn{2}{c}{\textbf{Sauce}}\\ \toprule
...
1 & inch GingerGently smashed. Fried when making the sauce.\\ \bottomrule
